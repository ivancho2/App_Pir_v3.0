...
function Modulo() {
	...
	this.Registrar_Modulo = function(str_Codigo_Nomenclatura_Modulo, str_nombre_Modulo, str_descripcion_Modulo, int_estado_switch_Modulo, str_estado_Modulo, int_Persona_identificacion_Persona) {
// mysql> insert into modulo values ('ESP8266_234TEST' ,'nombre_modulotest' ,'descripcion modulo test',1,'activo',1);
		return new Promise(function (response, reject){
			...
			// Codigo_Nomenclatura_Modulo     | varchar(45)
			// nombre_Modulo                  | varchar(45)
			// descripcion_Modulo             | varchar(50)
			// estado_switch_Modulo           | tinyint(1)
			// estado_Modulo                  | varchar(45)
			// Persona_identificacion_Persona | int(11)
			console.log(ObjP);
	...
	this.Consultar_Modulo = function(str_Codigo_Nomenclatura_Modulo) {
	...
	this.Modificar_Modulo = function(str_Codigo_Nomenclatura_Modulo, str_nombre_Modulo, str_descripcion_Modulo) {
	...
	this.Inhabilitar_Modulo = function(str_Codigo_Nomenclatura_Modulo) {
		return new Promise(function (response, reject){
			ObjP = {
